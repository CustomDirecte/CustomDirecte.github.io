...
function copyMode(bookmarklet, mainButton) {
  if (mainButton) {
    ...
    if (bookmarklets_code && bookmarklets_id) {
      ...
      bookmarklet.dataset.clipboardTarget = "#__code_0 > code";
    }
  } else {
    ...
    bookmarklets_copy.dataset.clipboardTarget = "#__code_0 > code";
